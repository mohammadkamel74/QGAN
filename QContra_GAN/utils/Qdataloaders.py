...
def CelebAHQ_dataloader(root, quat_data, img_size, normalize, batch_size, num_workers=2):
...
def CIFAR10_dataloader(root, quat_data, img_size, normalize, batch_size, num_workers=1, eval=False):
    ...
    if eval:
        ...
        # with open("./data/Test_FID_cifar/cifar-10-batches-py/test_batch", 'rb') as fo:
        #     test_dict = pickle.load(fo, encoding='bytes')
        # for elem in test_dict:
        #     # print(elem.shape)
        #     print(elem)
        #     img = Image.fromarray(elem[1], 'RGB')
        #     img.save("./data/Test_FID_cifar/test_cifar")
